...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    @BindView(R.id.temperatureLabel) TextView mTempValue;
    @BindView(R.id.locationLabel) TextView mLocationValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FontHelper.setCustomTypeface(mTempValue);
        FontHelper.setCustomTypeface(mLocationValue);
        ...
        if(isCelsius) {
            WeatherService.getWeather().weather(latitude, longitude, "metric").enqueue(new Callback<Root>() {
                ...
                public void onResponse(Call<Root> call, Response<Root> response) {
                    ...
                    mLocationValue.setText(place);
                    mHumidityValue.setText(String.format("%s %%", String.valueOf(response.body().getMain().getHumidity())));
                    mTempValue.setText(String.format("%s°", String.valueOf(Math.round(response.body().getMain().getTemp()))));
